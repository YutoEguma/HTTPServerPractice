...
public class HttpRequest {
    ...
    private void setRequestLineElement(String requestLine) {
        ...
        if (requestLineList.size() != 3) {
            throw new IncorrectRequestException("request-lineの形式が正しくありません requestLine :" + requestLine);
        }
    ...
    public String toString() {
        ...
        // request-line
        sb.append(CRLF)
                .append(this.method).append(SP).append(requestTarget).append(SP).append(httpVersion).append(CRLF);
